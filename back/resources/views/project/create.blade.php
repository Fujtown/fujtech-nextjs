              ...
              <div class="row">
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                    <form action="{{ route('store-project') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                            ...
                            <input type="hidden" name="description" id="content-input" value="{!! old('description') !!}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control flatpickr-date" id="basic-icon-default-message" name="publish_date" required placeholder="Select Publish Date">
                        </div>      
