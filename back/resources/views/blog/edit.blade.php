        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Blogs /</span> Edit Blog</h4>
                    ...
                    <div class="card-body">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mt-2">
                            <img src="{{ asset('storage/' . $blog->cover_image) }}" alt="{{ $blog->title }}" style="width: 100px; height: auto;">
                          </div>
                        </div>
                        <div class="mb-3">
                          ...
                          <input type="hidden" id="keywords-hidden" name="keywords" value="{{ $blog->keywords }}" />
                        </div>
                        <div class="mb-3">  
                          ...
                          <input type="hidden" id="tags-hidden" name="tags" value="{{ $blog->tags }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="content" id="content-input" value="{{ $blog->content }}">
                        </div>
...
<script>
  ...
  <script>
    ...
    const tagContainer = document.getElementById('tag-tags');
    ...
    function renderTags() {
        ...
        tags.forEach(tag => {
            ...
            removeButton.className = 'ms-1 cursor-pointer';
