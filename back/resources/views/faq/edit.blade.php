        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">FAQ /</span> Edit Faq</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Edit FAQ Content</h5>
                    ...
                    <div class="mb-3">
                            ...
                            <div id="editor-container" style="height: 300px;">{!! $faq->question !!}</div>
                            <input type="hidden" name="content" id="content-input" value="{{ $faq->question}}">
                        </div>
